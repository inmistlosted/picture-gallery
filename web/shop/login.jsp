...
<c:if test="${empty sessionScope.customer}">
    <h3 style="position: relative; display: block; width: 30%; left: 35%; text-align: center; font-size: 30px; margin-bottom: 15px">Вхід</h3>
    <form action="${pageContext.request.contextPath}/servlet/ClientServlet?op=login" method="post">
    	<table style="position: relative; width: 30%; left: 35%; border: 2px solid black; margin-bottom: 30px">
    		<tr style="border-bottom: 1px solid black">
    			<td style="padding: 30px; font-size: 20px; text-align: right">Ім'я користувача:</td>
    			<td>
    				<input name="username" style="border: 1px solid black; padding: 10px 0 10px 10px; width: 90%; margin-bottom: 10px"/>
    			</td>
    		</tr>
    		<tr style="border-bottom: 1px solid black">
    			<td style="padding: 30px; font-size: 20px; text-align: right">Пароль:</td>
    			<td>
    		...
    		<tr>
    			<td colspan="2">
    				<input type="submit" value="Увійти" style="width: 100%; padding: 10px 0; background: #a35f1b; color: white; font-size: 15px; border: none; cursor: pointer"
