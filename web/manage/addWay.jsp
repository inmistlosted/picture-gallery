    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Додати напрям</li>
            </ul>
            ...
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        ...
                        Підтвердити новий напрям
                    </small>
                </h1>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/servlet/ManageServlet?op=addWay" method="post">
...
<script type="text/javascript">
    document.getElementById("name").onblur = function () {
        ...
        xhr.open("GET", "${pageContext.request.contextPath}/servlet/ManageServlet?op=checkWay&name=" + nameValue + "&time=" + new Date().getTime());
        xhr.send(null);
    }
</script>
