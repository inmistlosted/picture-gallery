    ...
    <div class="main-content-inner">
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Редагувати картину</li>
            </ul>
            ...
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        ...
                        Підтвердити зміну картини
                    </small>
                </h1>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" enctype="multipart/form-data" action="${pageContext.request.contextPath}/servlet/ManageServlet?op=editPainting" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" placeholder="назва" class="col-xs-10 col-sm-5" name="name" value="${p.name}"/>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <select class="col-xs-10 col-sm-5" name="artistId">
                                    <c:forEach items="${as}" var="a">
                                        <c:if test="${a.name == p.artist.name}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="price" class="col-xs-10 col-sm-5" value="${p.price}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="des" class="col-xs-10 col-sm-5" rows="5">${p.des}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-9">
                                <select class="col-xs-10 col-sm-5" name="categoryId">
                                    <c:forEach items="${cs}" var="c">
                                        <c:if test="${c.name == p.category.name}">
