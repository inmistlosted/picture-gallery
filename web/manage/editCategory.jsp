        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action="${pageContext.request.contextPath}/servlet/ManageServlet?op=editCategory" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" placeholder="назва" class="col-xs-10 col-sm-5" name="name" value="${c.name}"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="des" class="col-xs-10 col-sm-5" rows="5" id="cat_des">${c.des}</textarea>
                            </div>
                        </div>
